...
public class ChangePasswordActivity extends HeaderBarActivity
{
	...
	protected void showLabels()
	{
		...
		m_txtPageTitle.setText(locale.ChangePWD);
		
		((TextView)findViewById(R.id.fragment_change_last).findViewById(R.id.txt_label)).setText(locale.OldPWDLabel);
		((TextView)findViewById(R.id.fragment_change_new).findViewById(R.id.txt_label)).setText(locale.NewPWDLabel);
		((TextView)findViewById(R.id.fragment_change_confirm).findViewById(R.id.txt_label)).setText(locale.ConfirmPWDLabel);
		
		m_btnChange.setText(locale.ChangePWD);
	}
